...
## Crate Setup
- [ ] Create `save-api` crate (Axum-based REST API)
- [ ] Create `save-storage` crate (object persistence)
- [ ] Create `save-metadata` crate (RocksDB layer)
...
## Core HTTP API
- [ ] Implement PUT /{bucket}/{object} with SigV4 auth
